...
/* harmony import */ var _objects_phoenix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./objects/phoenix */ "./src/objects/phoenix.js");
...
class Boss {
    constructor(ctx, x, y, dw, dh, player) {
        ...
        this.sprite = new _sprite__WEBPACK_IMPORTED_MODULE_0__["default"](this.image);
        ...
        this.phoenixFireSprite = new _sprite__WEBPACK_IMPORTED_MODULE_0__["default"](this.phoenixFire);
    ...
    isAttacked(spellId) {
        if (spellId === 1) {
            ...
            const flashSprite = new _sprite__WEBPACK_IMPORTED_MODULE_0__["default"](damaged);
...
/* harmony import */ var _objects_phoenix__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./objects/phoenix */ "./src/objects/phoenix.js");
/* harmony import */ var _game_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./game_model */ "./src/game_model.js");
...
class Game {
    constructor(ctx) {
        this.ctx = ctx;
        this.gameModel = new _game_model__WEBPACK_IMPORTED_MODULE_3__["default"](ctx);
        this.player = new _player__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, 125, 130, 110, 160);
        this.boss = new _boss__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, 350, 0, 500, 450, this.player);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _objects_circle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objects/circle */ "./src/objects/circle.js");
...
class GameModel {
    ...
    circleOuter() {
        for (let y = this.ch / 8; y <= this.ch ; y += this.ch / 4) {
            for (let x = this.cw / 6; x <= this.cw; x += this.cw / 3) {
                const circle = new _objects_circle__WEBPACK_IMPORTED_MODULE_0__["default"](x, y, 'pink', 30, this.ctx)
                circle.draw()
            }
        }
        ...
        for (let y = 0; y <= this.ch; y += this.ch / 4) {
            for (let x = 0; x <= this.cw; x += this.cw / 3) {
                const circle = new _objects_circle__WEBPACK_IMPORTED_MODULE_0__["default"](x, y, 'blue', 30, this.ctx)
                circle.draw()
            }
        }
    }
    ...
    circleInner() {
        for (let y = this.ch / 8; y <= this.ch; y += this.ch / 4) {
            for (let x = this.cw / 6; x <= this.cw; x += this.cw / 3) {
                const circle = new _objects_circle__WEBPACK_IMPORTED_MODULE_0__["default"](x, y, 'blue', 25, this.ctx)
                circle.draw()
            }
        }
        ...
        for (let y = 0; y <= this.ch; y += this.ch / 4) {
            for (let x = 0; x <= this.cw; x += this.cw / 3) {
                const circle = new _objects_circle__WEBPACK_IMPORTED_MODULE_0__["default"](x, y, 'pink', 25, this.ctx)
                circle.draw()
            }
        }
    }
...
class Player {
    constructor(ctx, x, y, dw, dh) {
        ...
        this.spellSprite = new _sprite__WEBPACK_IMPORTED_MODULE_0__["default"](this.spellSheets)
